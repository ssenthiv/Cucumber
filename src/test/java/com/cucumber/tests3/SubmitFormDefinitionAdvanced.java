...
public class SubmitFormDefinitionAdvanced  {
	 String methodName; 
	 Base base;
	 static {
		...
		Base.Add_Log.debug("**** static block: " + SubmitFormDefinitionAdvanced.class.getName()+"  **** " );
	 }
	 
	 public SubmitFormDefinitionAdvanced(Base base) {
			
		 methodName=Thread.currentThread().getStackTrace()[1].getMethodName();
		 base.Add_Log.info("\tExecuting SubmitFormDefinitionAdvanced constructor- "+ this.getClass().getSimpleName()+"."+methodName);
		 this.base=base;
	...
	public void user_launches_http_integr_a_trclient_com_Page(int arg1) throws Throwable {
	    ...
	    base.Add_Log.info("^User (?:launches|opens|navigates) http://integr(\\d+)a\\.trclient\\.com Page$");
	    //driver.get(param.getProperty("URL"));
	    base.module1=base.login.navigateToModule(base.param.getProperty("URL"));
	...
	public void user_fills_the_form_with_data(DataTable dataTable) throws Throwable {
		...
		base.Add_Log.info("^User fills the form with correct data");
	...
	public void i_verify_the_Form_not_submitted() throws Throwable {
	   ...
	   base.Add_Log.info("^I verify the Form not submitted$");
	...
	public void user_submit_the_form_with_multiple_incorrect_data(DataTable dataTable) throws Throwable {
		...
		base.Add_Log.info("^User submit the form with multiple correct data and verify form$");
		...
		public void user_submit_the_form_with_multiple_data_withScenarioTemplate(String FirstName , String LastName, String Email, String MobileNo, String Address, String Suburb,String State,String PostCode,String Dob,String TermsAndCondition,String Submit) throws Throwable {
			...
			base.Add_Log.info("^User Enters data for Scenario Template FirstName(.*) ... $");
